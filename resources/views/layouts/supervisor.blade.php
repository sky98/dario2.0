	...
	<nav id="fh5co-main-nav" role="navigation">
		...
		<div class="js-fullheight fh5co-table">
			<div class="fh5co-table-cell js-fullheight">
				<ul>
					<li @yield('home')><a href="{{ action('SupervisorController@main') }}">Principal</a></li>
					<li @yield('register')><a href="{{ action('SupervisorController@register') }}">Registrar</a></li>
					<li @yield('personal')><a href="{{ action('SupervisorController@personal') }}">Personal</a></li>
